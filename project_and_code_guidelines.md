...
* Private, non-static field names start with __m__ (except POJO and DTO classes like DB entities and generated classes for Retrofit).
...
There are two __exceptions__ where it is possible to have lines longer than 150:
